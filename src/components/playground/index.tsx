      ...
      <section className="relative bg-neutral-950 px-6 py-24 md:py-36">
        <div className="mx-auto max-w-6xl text-center">
          ...
          <p className="mx-auto mt-4 max-w-lg text-base leading-relaxed text-neutral-500 md:text-lg">
            Upload your own image and scrub through singular values in
            real-time. Drag the divider to compare compressed vs. original.
          </p>
        </div>
            ...
            <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 px-4 backdrop-blur-sm">
              ...
              >
                ...
                <p className="mt-2 text-sm text-neutral-400">
                  SVD calculation is computationally heavy. On mobile devices,
                  this might take a considerable amount of time. Consider using
                  a Desktop for a smoother experience.
                </p>
                <div className="mt-6 flex justify-end gap-3">
                  <button
                    ...
                    className="rounded-lg px-4 py-2 text-sm font-medium text-neutral-400 transition-colors hover:bg-white/5 hover:text-neutral-100"
                  >
                    Cancel
                  </button>
                  <button
                    ...
                    className="bg-accent hover:bg-accent/90 rounded-lg px-4 py-2 text-sm font-medium text-neutral-950 transition-colors"
                  >
                    Continue anyway
                  </button>
                </div>
